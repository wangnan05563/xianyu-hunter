        ...
        <Row gutter={16}>
          <Col span={8}>
            <div>
              ...
              <InputNumber
                value={usage.budget.daily_token_limit}
                onChange={(v) =>
                  setUsage((prev) => ({ ...prev, budget: { ...prev.budget, daily_token_limit: v ?? 500000 } }))
                }
                placeholder="500000"
                style={{ width: '100%' }}
                min={0}
          ...
          <Col span={8}>
            <div>
              ...
              <InputNumber
                value={usage.budget.daily_cost_limit_usd}
                onChange={(v) =>
                  setUsage((prev) => ({ ...prev, budget: { ...prev.budget, daily_cost_limit_usd: v ?? 5 } }))
                }
                placeholder="5.0"
                style={{ width: '100%' }}
                min={0}
          ...
          <Col span={8}>
            <div>
              ...
              <InputNumber
                value={usage.budget.rate_limit_per_min}
                onChange={(v) =>
                  setUsage((prev) => ({ ...prev, budget: { ...prev.budget, rate_limit_per_min: v ?? 20 } }))
                }
                placeholder="20"
                style={{ width: '100%' }}
                min={0}
