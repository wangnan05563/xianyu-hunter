...
from xianyu_hunter.modules.dealer_detector import detect_dealer
...
class Evaluator:
    ...
    def _evaluate_full(
        ...
        professional_score, professional_reasons = self._eval_professional(seller, item)
    ...
    def _evaluate_partial(
        ...
        if "professional" in valid_dims:
            s, r = self._eval_professional(seller, item)
