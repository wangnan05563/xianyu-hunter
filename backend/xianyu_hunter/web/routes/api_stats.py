...
- stats_eval_funnel.py → 评估漏斗 + 命中率/误报率（/stats/eval-funnel）
- stats_price_trend.py → 价格趋势对比基线（/stats/price-trend）
"""
...
from xianyu_hunter.web.routes.stats_eval_funnel import router as eval_funnel_router
from xianyu_hunter.web.routes.stats_price_trend import router as price_trend_router
...
router.include_router(eval_funnel_router)
router.include_router(price_trend_router)
