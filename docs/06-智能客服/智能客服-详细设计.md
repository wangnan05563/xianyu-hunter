...
| 后端路由 | `backend/xianyu_hunter/web/routes/api_chatbot.py`、`api_chatbot_config.py`、`api_kb.py` |
...
**位置**：[modules/chatbot/local_embedding.py](file:///d:/code/otherProjects/17_xianyu/backend/xianyu_hunter/modules/chatbot/local_embedding.py)
...
**位置**：[frontend/src/pages/Chatbot/components/VectorAdminPanel.tsx](file:///d:/code/otherProjects/17_xianyu/frontend/src/pages/Chatbot/components/VectorAdminPanel.tsx) → [backend/xianyu_hunter/web/routes/api_kb.py](file:///d:/code/otherProjects/17_xianyu/backend/xianyu_hunter/web/routes/api_kb.py)
...
**位置**：[modules/chatbot/tool_registry.py](file:///d:/code/otherProjects/17_xianyu/backend/xianyu_hunter/modules/chatbot/tool_registry.py)
...
**位置**：[modules/chatbot/embedding_service.py](file:///d:/code/otherProjects/17_xianyu/backend/xianyu_hunter/modules/chatbot/embedding_service.py) + [modules/chatbot/local_embedding.py](file:///d:/code/otherProjects/17_xianyu/backend/xianyu_hunter/modules/chatbot/local_embedding.py)
