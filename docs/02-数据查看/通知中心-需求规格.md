...
| 通知中心 后端路由 | [../../src/xianyu_hunter/web/routes/api_notifications.py](../../src/xianyu_hunter/web/routes/api_notifications.py) | 7 个端点 + `_ALLOWED_LEVELS` / `_ALLOWED_CATEGORIES` 白名单 |
| 通知中心 通知引擎 | [../../src/xianyu_hunter/web/services/notification_engine.py](../../src/xianyu_hunter/web/services/notification_engine.py) | `scan_and_notify` 聚合入口 + 2 条规则 |
| 通知中心 数据模型 | [../../src/xianyu_hunter/infra/db_models.py](../../src/xianyu_hunter/infra/db_models.py) | `NotificationRow` 9 字段 + `uq_notification_dedup` 约束 |
...
| 通知中心 仓储层 | [../../src/xianyu_hunter/infra/repo_notifications.py](../../src/xianyu_hunter/infra/repo_notifications.py) | `NotificationsMixin` 提供 8 个 CRUD 方法 |
| 登录态查询 API | [../../src/xianyu_hunter/web/routes/auth_query.py](../../src/xianyu_hunter/web/routes/auth_query.py) | `/api/auth/me` 在第 223 行调用 `scan_and_notify` |
...
1. **集成部署**：作为 `src/xianyu_hunter/web/routes/api_notifications.py` 路由 + `frontend/src/pages/Notifications/index.tsx` 页面集成到现有系统，不独立部署
...
- 调用方：`src/xianyu_hunter/web/routes/auth_query.py:223` 在 `/api/auth/me` 端点中调用，传入 `auth_state=result`
...
所有接口前缀：`/api/notifications`，路由文件：`src/xianyu_hunter/web/routes/api_notifications.py`，认证：复用现有 `auth.py` 中间件（**不加入白名单**）。
...
| 模块 | 文件路径 | 行号 |
|------|----------|------|
| 路由声明 | `src/xianyu_hunter/web/routes/api_notifications.py` | 16 |
| `_ALLOWED_LEVELS` | `src/xianyu_hunter/web/routes/api_notifications.py` | 22 |
| `_ALLOWED_CATEGORIES` | `src/xianyu_hunter/web/routes/api_notifications.py` | 23 |
| `list_notifications` | `src/xianyu_hunter/web/routes/api_notifications.py` | 26-47 |
| `unread_count` | `src/xianyu_hunter/web/routes/api_notifications.py` | 50-55 |
| `create_notification` | `src/xianyu_hunter/web/routes/api_notifications.py` | 58-102 |
| `mark_read` | `src/xianyu_hunter/web/routes/api_notifications.py` | 105-115 |
| `mark_all_read` | `src/xianyu_hunter/web/routes/api_notifications.py` | 118-124 |
| `delete_notification` | `src/xianyu_hunter/web/routes/api_notifications.py` | 127-137 |
| `clear_notifications` | `src/xianyu_hunter/web/routes/api_notifications.py` | 140-153 |
| NotificationRow 类 | `src/xianyu_hunter/infra/db_models.py` | 305-319 |
| uq_notification_dedup 约束 | `src/xianyu_hunter/infra/db_models.py` | 308 |
| created_at 索引 | `src/xianyu_hunter/infra/db_models.py` | 319 |
| ORDER_TIMEOUT_RULES | `src/xianyu_hunter/web/services/notification_engine.py` | 28-32 |
| `scan_order_timeouts` | `src/xianyu_hunter/web/services/notification_engine.py` | 35-77 |
| `_scan_auth_down` | `src/xianyu_hunter/web/services/notification_engine.py` | 80-125 |
| `scan_and_notify` | `src/xianyu_hunter/web/services/notification_engine.py` | 128-150 |
| 通知引擎调用入口 | `src/xianyu_hunter/web/routes/auth_query.py` | 223 |
