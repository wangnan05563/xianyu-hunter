...
| 品类统计 API | [../../backend/xianyu_hunter/web/routes/price_dashboard.py](../../backend/xianyu_hunter/web/routes/price_dashboard.py) | 3 端点 + 8 内部辅助函数 |
| 价格直方图 API | [../../backend/xianyu_hunter/web/routes/price_histogram.py](../../backend/xianyu_hunter/web/routes/price_histogram.py) | 2 端点 + 8 内部辅助函数 |
| 价格趋势 API | [../../backend/xianyu_hunter/web/routes/stats_price_trend.py](../../backend/xianyu_hunter/web/routes/stats_price_trend.py) | 1 端点 + 2 内部辅助函数 |
| DB 模型 | [../../backend/xianyu_hunter/infra/db_models.py](../../backend/xianyu_hunter/infra/db_models.py) | ItemRow:98 / TaskRow:50 / TaskLinkRow:256 |
...
**文件**：`backend/xianyu_hunter/web/routes/price_dashboard.py`
...
**文件**：`backend/xianyu_hunter/web/routes/price_histogram.py`
...
**文件**：`backend/xianyu_hunter/web/routes/stats_price_trend.py`
...
| 模块 | 文件路径 | 行号 |
|------|----------|------|
| `_percentile`（dashboard） | `backend/xianyu_hunter/web/routes/price_dashboard.py` | 29-42 |
| `_compute_stats` | `backend/xianyu_hunter/web/routes/price_dashboard.py` | 45-68 |
| `_load_category_prices` | `backend/xianyu_hunter/web/routes/price_dashboard.py` | 71-125 |
| `GET /api/prices/category-stats` | `backend/xianyu_hunter/web/routes/price_dashboard.py` | 128-159 |
| `_ALLOWED_COMPARISON_SORT` | `backend/xianyu_hunter/web/routes/price_dashboard.py` | 162 |
| `_normalize_comparison_params` | `backend/xianyu_hunter/web/routes/price_dashboard.py` | 165-174 |
| `_filter_category_prices_by_range` | `backend/xianyu_hunter/web/routes/price_dashboard.py` | 177-209 |
| `_make_comparison_sort_key` | `backend/xianyu_hunter/web/routes/price_dashboard.py` | 212-224 |
| `_compute_deviation_pct` | `backend/xianyu_hunter/web/routes/price_dashboard.py` | 227-231 |
| `GET /api/prices/category-comparison` | `backend/xianyu_hunter/web/routes/price_dashboard.py` | 234-286 |
| `_MIN_SOLD_SAMPLES` | `backend/xianyu_hunter/web/routes/price_dashboard.py` | 292 |
| `_load_sold_prices_from_links` | `backend/xianyu_hunter/web/routes/price_dashboard.py` | 295-334 |
| `_load_all_prices_from_items` | `backend/xianyu_hunter/web/routes/price_dashboard.py` | 337-353 |
| `GET /api/prices/sold-range` | `backend/xianyu_hunter/web/routes/price_dashboard.py` | 356-430 |
| `_percentile`（histogram） | `backend/xianyu_hunter/web/routes/price_histogram.py` | 27-40 |
| `_PRICE_TICKS` | `backend/xianyu_hunter/web/routes/price_histogram.py` | 24 |
| `_build_compare_means` | `backend/xianyu_hunter/web/routes/price_histogram.py` | 43-77 |
| `_build_buckets` | `backend/xianyu_hunter/web/routes/price_histogram.py` | 80-93 |
| `_resolve_histogram_scope` | `backend/xianyu_hunter/web/routes/price_histogram.py` | 96-127 |
| `_load_histogram_samples` | `backend/xianyu_hunter/web/routes/price_histogram.py` | 130-153 |
| `_build_empty_histogram_summary` | `backend/xianyu_hunter/web/routes/price_histogram.py` | 156-163 |
| `_build_histogram_summary` | `backend/xianyu_hunter/web/routes/price_histogram.py` | 166-182 |
| `_compute_auto_bins_bounds` | `backend/xianyu_hunter/web/routes/price_histogram.py` | 185-207 |
| `_build_auto_bins` | `backend/xianyu_hunter/web/routes/price_histogram.py` | 210-226 |
| `GET /api/prices/histogram` | `backend/xianyu_hunter/web/routes/price_histogram.py` | 229-294 |
| `POST /api/prices/analyze` | `backend/xianyu_hunter/web/routes/price_histogram.py` | 297-384 |
| `_safe_mean` | `backend/xianyu_hunter/web/routes/stats_price_trend.py` | 26-28 |
| `_safe_diff` | `backend/xianyu_hunter/web/routes/stats_price_trend.py` | 31-35 |
| `GET /api/stats/price-trend` | `backend/xianyu_hunter/web/routes/stats_price_trend.py` | 38-108 |
| `ItemRow` ORM 模型 | `backend/xianyu_hunter/infra/db_models.py` | 98-130 |
| `TaskRow` ORM 模型 | `backend/xianyu_hunter/infra/db_models.py` | 50-94 |
| `TaskLinkRow` ORM 模型 | `backend/xianyu_hunter/infra/db_models.py` | 256-279 |
