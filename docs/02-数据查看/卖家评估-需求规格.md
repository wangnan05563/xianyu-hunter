...
| 约束 | 说明 |
|------|------|
| **后端框架** | FastAPI（`src/xianyu_hunter/web/routes/api_evaluations.py`） |
...
| 层 | 文件 | 职责 |
|----|------|------|
| 路由层 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 13 个 RESTful 端点、请求/响应模型、参数校验、错误处理 |
| 服务层 | `src/xianyu_hunter/modules/evaluator.py` | `Evaluator` 主类、4 维评分、数据质量分级、防高分掩盖、AI 评估集成 |
| 领域层 | `src/xianyu_hunter/domain/evaluation.py` | `EvalResult` / `RiskLevel` 数据类与枚举 |
| 仓储层 | `src/xianyu_hunter/infra/db_models.py` | `EvaluationRow` / `EventRow` / `ErrorLogRow` ORM 模型（evaluations 7 字段） |
| 容器层 | `src/xianyu_hunter/container.py` | `Container` 单例依赖注入（`evaluator` / `repo` / `event_bus`） |
| 配置层 | `src/xianyu_hunter/infra/yaml_config.py` | `EvalConfig` 配置加载（`weights` / `thresholds` / `professional_keywords` / `pass_score` / `auto_buy_score`） |
| 事件层 | `src/xianyu_hunter/domain/events.py` | `Event` / `EventType` 事件模型 |
...
| 模块 | 文件路径 | 行号 |
|------|----------|------|
| 路由声明 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 23 |
| 评估明细列表（不读 evaluations 表） | `src/xianyu_hunter/web/routes/api_evaluations.py` | 564 |
| 单条最新评估 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 881 |
| 官方采集统计 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 945 |
| 风险等级分布 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 1249 |
| 卖家价格趋势 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 1405 |
| 阈值建议 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 1500 |
| 卖家行为趋势 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 1555 |
| 评估反馈提交 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 1594 |
| 反馈统计 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 1651 |
| 手动重算 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 2043 |
| 批量评估未评估 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 2332 |
| 批量官方采集 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 2550 |
| 单条官方采集 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 2617 |
| 7 类成色关键词 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 699-727 |
| seller_nick 脏数据识别 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 55-94 |
| seller_nick 脏数据清洗 | `src/xianyu_hunter/web/routes/api_evaluations.py` | 150+ |
| Evaluator 主类 | `src/xianyu_hunter/modules/evaluator.py` | 68 |
| evaluate 方法 | `src/xianyu_hunter/modules/evaluator.py` | 114 |
| _evaluate_full | `src/xianyu_hunter/modules/evaluator.py` | 150 |
| _evaluate_partial | `src/xianyu_hunter/modules/evaluator.py` | 217 |
| _evaluate_insufficient | `src/xianyu_hunter/modules/evaluator.py` | 273 |
| _score_to_risk | `src/xianyu_hunter/modules/evaluator.py` | 299 |
| apply_ai_eval | `src/xianyu_hunter/modules/evaluator.py` | 310 |
| _get_valid_dimensions | `src/xianyu_hunter/modules/evaluator.py` | 371 |
| _veto 一票否决 | `src/xianyu_hunter/modules/evaluator.py` | 403 |
| _eval_professional | `src/xianyu_hunter/modules/evaluator.py` | 427 |
| _eval_credit | `src/xianyu_hunter/modules/evaluator.py` | 530 |
| _eval_dispute | `src/xianyu_hunter/modules/evaluator.py` | 557 |
| _eval_price | `src/xianyu_hunter/modules/evaluator.py` | 574 |
| _eval_popularity | `src/xianyu_hunter/modules/evaluator.py` | 625 |
| 防高分掩盖 buffer 计算 | `src/xianyu_hunter/modules/evaluator.py` | 195-204 |
| EvalResult dataclass | `src/xianyu_hunter/domain/evaluation.py` | 18 |
| RiskLevel 枚举 | `src/xianyu_hunter/domain/evaluation.py` | 9 |
| should_pass 方法 | `src/xianyu_hunter/domain/evaluation.py` | 52 |
| should_auto_buy 方法 | `src/xianyu_hunter/domain/evaluation.py` | 73 |
| EvaluationRow ORM | `src/xianyu_hunter/infra/db_models.py` | 154 |
| EventRow ORM | `src/xianyu_hunter/infra/db_models.py` | 194 |
| ErrorLogRow ORM | `src/xianyu_hunter/infra/db_models.py` | 219 |
| ai_context_json / ai_context_md | `src/xianyu_hunter/infra/db_models.py` | 245-246 |
