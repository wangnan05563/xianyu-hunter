...
| 时间线后端 | [../../src/xianyu_hunter/web/routes/timeline.py](../../src/xianyu_hunter/web/routes/timeline.py) | 聚合 API + `_to_utc_iso` 辅助 |
| SSE 后端 | [../../src/xianyu_hunter/web/routes/sse_stream.py](../../src/xianyu_hunter/web/routes/sse_stream.py) | 4 个辅助函数 + 实时流 |
| EventBus | [../../src/xianyu_hunter/infra/event_bus.py](../../src/xianyu_hunter/infra/event_bus.py) | asyncio.Queue 订阅/发布 + `_dispatch` |
| EventType 枚举 | [../../src/xianyu_hunter/domain/events.py](../../src/xianyu_hunter/domain/events.py) | 35 种事件 + EVENT_SEVERITY |
| request_id | [../../src/xianyu_hunter/infra/request_context.py](../../src/xianyu_hunter/infra/request_context.py) | generate / get / set / new_request_scope |
| EventRow 模型 | [../../src/xianyu_hunter/infra/db_models.py](../../src/xianyu_hunter/infra/db_models.py) | events 表 10 字段 + 6 索引 |
...
1. **集成部署**：作为 `src/xianyu_hunter/web/routes/timeline.py` + `src/xianyu_hunter/web/routes/sse_stream.py` 路由 + `frontend/src/pages/Timeline/index.tsx` 页面集成到现有系统，不独立部署
...
**FR-2.1** `EventType(str, Enum)` 定义于 `src/xianyu_hunter/domain/events.py:9`，**共 35 种**（v1.0 文档误写 21 种，**修正为 35 种**）
...
**FR-4.1** `EventBus` 类定义于 `src/xianyu_hunter/infra/event_bus.py`，基于 `asyncio.Queue` 的进程内事件分发
...
所有接口前缀：`/api`，时间线相关路由文件：`src/xianyu_hunter/web/routes/timeline.py` 与 `src/xianyu_hunter/web/routes/sse_stream.py`，认证：复用现有 `auth.py` 中间件（**不加入白名单**）。
...
### 6.1 events 表（EventRow，`src/xianyu_hunter/infra/db_models.py:194`）
...
### 6.4 Event dataclass（`src/xianyu_hunter/domain/events.py:115`）
...
| 模块 | 文件路径 | 行号 |
|------|----------|------|
| 时间线路由声明 | `src/xianyu_hunter/web/routes/timeline.py` | 17 |
| `_to_utc_iso` | `src/xianyu_hunter/web/routes/timeline.py` | 20-35 |
| `timeline` 端点 | `src/xianyu_hunter/web/routes/timeline.py` | 38-77 |
| SSE 路由声明 | `src/xianyu_hunter/web/routes/sse_stream.py` | 19 |
| `_MAX_SSE_CONNECTIONS` | `src/xianyu_hunter/web/routes/sse_stream.py` | 22 |
| `_sse_connection_count` | `src/xianyu_hunter/web/routes/sse_stream.py` | 23 |
| `_sse_gate` | `src/xianyu_hunter/web/routes/sse_stream.py` | 24 |
| `_format_sse_event` | `src/xianyu_hunter/web/routes/sse_stream.py` | 27-33 |
| `_load_replay_events` | `src/xianyu_hunter/web/routes/sse_stream.py` | 36-44 |
| `_load_new_events` | `src/xianyu_hunter/web/routes/sse_stream.py` | 47-50 |
| `events_stream` 端点 | `src/xianyu_hunter/web/routes/sse_stream.py` | 53-118 |
| EventType 枚举 | `src/xianyu_hunter/domain/events.py` | 9-55 |
| EVENT_SEVERITY 字典 | `src/xianyu_hunter/domain/events.py` | 62-85 |
| chatbot setdefault 严重度 | `src/xianyu_hunter/domain/events.py` | 99-111 |
| severity_of 函数 | `src/xianyu_hunter/domain/events.py` | 88-90 |
| Event dataclass | `src/xianyu_hunter/domain/events.py` | 114-132 |
| EventBus 类 | `src/xianyu_hunter/infra/event_bus.py` | 21-97 |
| EventBus `_dispatch` | `src/xianyu_hunter/infra/event_bus.py` | 69-88 |
| EventBus `_safe_call` | `src/xianyu_hunter/infra/event_bus.py` | 90-96 |
| `get_event_bus` | `src/xianyu_hunter/infra/event_bus.py` | 103-107 |
| `_request_id_var` | `src/xianyu_hunter/infra/request_context.py` | 21 |
| `_gen_lock` | `src/xianyu_hunter/infra/request_context.py` | 25 |
| `_REQUEST_ID_PREFIX` | `src/xianyu_hunter/infra/request_context.py` | 28 |
...
| EventRow 模型 | `src/xianyu_hunter/infra/db_models.py` | 194-213 |
| `ix_events_task_created` | `src/xianyu_hunter/infra/db_models.py` | 211-213 |
| ErrorLogRow 模型 | `src/xianyu_hunter/infra/db_models.py` | 219+ |
