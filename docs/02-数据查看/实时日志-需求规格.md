...
| 实时日志 后端 | [../../src/xianyu_hunter/web/routes/api_logs.py](../../src/xianyu_hunter/web/routes/api_logs.py) | 7 个端点（list/search/tag/untag/export/stream/request_chain） |
...
| 错误捕获中间件 | [../../src/xianyu_hunter/web/middleware/error_capture.py](../../src/xianyu_hunter/web/middleware/error_capture.py) | `capture_request_error` + `capture_background_error` 双入口 |
| request_id 上下文 | [../../src/xianyu_hunter/infra/request_context.py](../../src/xianyu_hunter/infra/request_context.py) | `generate_request_id` / `is_valid_request_id` |
| EventRow 模型 | [../../src/xianyu_hunter/infra/db_models.py](../../src/xianyu_hunter/infra/db_models.py) | 第 194 行 events 表定义 |
| 事件时间线 SSE | [../../src/xianyu_hunter/web/routes/sse_stream.py](../../src/xianyu_hunter/web/routes/sse_stream.py) | `/api/events/stream` 路由（前端实际订阅） |
...
1. **集成部署**：作为 `src/xianyu_hunter/web/routes/api_logs.py` 路由 + `frontend/src/pages/Logs/Logs.tsx` 页面集成到现有系统，不独立部署
...
所有接口前缀：`/api/logs`，路由文件：`src/xianyu_hunter/web/routes/api_logs.py`，认证：复用现有 `auth.py` 中间件（**不加入白名单**）。
...
| 模块 | 文件路径 | 行号 |
|------|----------|------|
| 路由声明 | `src/xianyu_hunter/web/routes/api_logs.py` | 34 |
| STDOUT_LOG_FILENAME | `src/xianyu_hunter/web/routes/api_logs.py` | 41 |
| STDERR_LOG_FILENAME | `src/xianyu_hunter/web/routes/api_logs.py` | 42 |
| _fetch_log_candidates | `src/xianyu_hunter/web/routes/api_logs.py` | 70-92 |
| _filter_log_candidates | `src/xianyu_hunter/web/routes/api_logs.py` | 95-124 |
| _compute_log_histograms | `src/xianyu_hunter/web/routes/api_logs.py` | 127-141 |
| GET /api/logs | `src/xianyu_hunter/web/routes/api_logs.py` | 46-66 |
| GET /api/logs/search | `src/xianyu_hunter/web/routes/api_logs.py` | 144-200 |
| POST /api/logs/tag | `src/xianyu_hunter/web/routes/api_logs.py` | 207-237 |
| DELETE /api/logs/tag | `src/xianyu_hunter/web/routes/api_logs.py` | 240-266 |
| GET /api/logs/export | `src/xianyu_hunter/web/routes/api_logs.py` | 270-330 |
| _export_log_file | `src/xianyu_hunter/web/routes/api_logs.py` | 333-348 |
| _event_tags | `src/xianyu_hunter/web/routes/api_logs.py` | 352-362 |
| _format_sse | `src/xianyu_hunter/web/routes/api_logs.py` | 366-372 |
| _match_request_id | `src/xianyu_hunter/web/routes/api_logs.py` | 375-383 |
| _read_log_chunk | `src/xianyu_hunter/web/routes/api_logs.py` | 386-402 |
| GET /api/logs/stream | `src/xianyu_hunter/web/routes/api_logs.py` | 405-440 |
| GET /api/logs/request/{request_id} | `src/xianyu_hunter/web/routes/api_logs.py` | 444-505 |
| capture_request_error | `src/xianyu_hunter/web/middleware/error_capture.py` | 216-258 |
| capture_background_error | `src/xianyu_hunter/web/middleware/error_capture.py` | 261-297 |
| _save_error_log | `src/xianyu_hunter/web/middleware/error_capture.py` | 152-213 |
| _sanitize_headers | `src/xianyu_hunter/web/middleware/error_capture.py` | 28-36 |
| _SENSITIVE_HEADERS | `src/xianyu_hunter/web/middleware/error_capture.py` | 25 |
| _build_ai_context_json | `src/xianyu_hunter/web/middleware/error_capture.py` | 94-111 |
| _build_ai_context_md | `src/xianyu_hunter/web/middleware/error_capture.py` | 114-149 |
| _infer_possible_causes | `src/xianyu_hunter/web/middleware/error_capture.py` | 49-70 |
| generate_request_id | `src/xianyu_hunter/infra/request_context.py` | 31-44 |
| is_valid_request_id | `src/xianyu_hunter/infra/request_context.py` | 93-113 |
| get_request_id | `src/xianyu_hunter/infra/request_context.py` | 47-53 |
| set_request_id | `src/xianyu_hunter/infra/request_context.py` | 56-62 |
| clear_request_id | `src/xianyu_hunter/infra/request_context.py` | 65-67 |
| new_request_scope | `src/xianyu_hunter/infra/request_context.py` | 70-85 |
| reset_request_scope | `src/xianyu_hunter/infra/request_context.py` | 88-90 |
| EventRow 类 | `src/xianyu_hunter/infra/db_models.py` | 194-213 |
| ErrorLogRow 类 | `src/xianyu_hunter/infra/db_models.py` | 219-250 |
| events.request_id 迁移 | `src/xianyu_hunter/infra/db_models.py` | 898-904 |
