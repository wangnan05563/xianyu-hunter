...
| 抢单记录 后端 | [../../src/xianyu_hunter/web/routes/api_orders.py](../../src/xianyu_hunter/web/routes/api_orders.py) | 8 端点 + 1 内部函数 + 4 辅助函数 |
| 抢单记录 前端页面 | [../../frontend/src/pages/Orders/Orders.tsx](../../frontend/src/pages/Orders/Orders.tsx) | 订单表格 + TakeoverModal + 利润计算器 |
| OrderStatus 枚举 | [../../src/xianyu_hunter/domain/order.py](../../src/xianyu_hunter/domain/order.py) | 4 核心枚举值定义 |
| OrderRow 模型 | [../../src/xianyu_hunter/infra/db_models.py](../../src/xianyu_hunter/infra/db_models.py) | orders 表 ORM 定义（L172-L191） |
| Buyer 模块 | [../../src/xianyu_hunter/modules/buyer.py](../../src/xianyu_hunter/modules/buyer.py) | 抢单核心、_task_item_set 幂等 |
| BuyerConfig | [../../src/xianyu_hunter/modules/buyer_config.py](../../src/xianyu_hunter/modules/buyer_config.py) | click_retry_times=2、price_tolerance=0.05 |
| TakeoverTimeoutScheduler | [../../src/xianyu_hunter/modules/takeover_timeout_scheduler.py](../../src/xianyu_hunter/modules/takeover_timeout_scheduler.py) | APScheduler BackgroundScheduler 实现 |
| SSE 事件流 | [../../src/xianyu_hunter/web/routes/sse_stream.py](../../src/xianyu_hunter/web/routes/sse_stream.py) | `/api/events/stream` 推送 |
| TaskDepRow | [../../src/xianyu_hunter/infra/db_models.py](../../src/xianyu_hunter/infra/db_models.py) | F-16 依赖关系表（task_deps） |
...
1. **集成部署**：作为 `src/xianyu_hunter/web/routes/api_orders.py` 路由 + `frontend/src/pages/Orders/Orders.tsx` 页面集成到现有系统，不独立部署
...
所有接口前缀：`/api/orders`，路由文件：`src/xianyu_hunter/web/routes/api_orders.py`，认证：复用现有 `auth.py` 中间件（**不加入白名单**）。
...
| 模块 | 文件路径 | 行号 |
|------|----------|------|
| 路由声明 | `src/xianyu_hunter/web/routes/api_orders.py` | 14 |
| TAKEOVER_TIMEOUT_MIN 常量 | `src/xianyu_hunter/web/routes/api_orders.py` | 20 |
| _parse_takeover_ts | `src/xianyu_hunter/web/routes/api_orders.py` | 26-39 |
| _apply_takeover_deadline | `src/xianyu_hunter/web/routes/api_orders.py` | 42-58 |
| GET /api/orders | `src/xianyu_hunter/web/routes/api_orders.py` | 61-95 |
| GET /{order_id} | `src/xianyu_hunter/web/routes/api_orders.py` | 98-106 |
| DELETE /{order_id} | `src/xianyu_hunter/web/routes/api_orders.py` | 109-124 |
| POST /{order_id}/takeover | `src/xianyu_hunter/web/routes/api_orders.py` | 127-170 |
| POST /{order_id}/takeover/confirm | `src/xianyu_hunter/web/routes/api_orders.py` | 173-196 |
| POST /{order_id}/takeover/cancel | `src/xianyu_hunter/web/routes/api_orders.py` | 199-220 |
| PATCH /{order_id}/status | `src/xianyu_hunter/web/routes/api_orders.py` | 223-263 |
| _trigger_dependent_tasks | `src/xianyu_hunter/web/routes/api_orders.py` | 266-318 |
| _parse_takeover_payload | `src/xianyu_hunter/web/routes/api_orders.py` | 321-327 |
| _ensure_takeover_prerequisites | `src/xianyu_hunter/web/routes/api_orders.py` | 330-351 |
| _resolve_takeover_item | `src/xianyu_hunter/web/routes/api_orders.py` | 354-365 |
| _check_existing_takeover_order | `src/xianyu_hunter/web/routes/api_orders.py` | 368-382 |
| _format_takeover_result | `src/xianyu_hunter/web/routes/api_orders.py` | 385-412 |
| POST /manual-takeover | `src/xianyu_hunter/web/routes/api_orders.py` | 415-483 |
| OrderStatus 枚举 | `src/xianyu_hunter/domain/order.py` | 9-13 |
| BuyOutcome 枚举 | `src/xianyu_hunter/domain/order.py` | - |
| ItemSoldError | `src/xianyu_hunter/domain/order.py` | - |
| OrderRow 模型 | `src/xianyu_hunter/infra/db_models.py` | 172-190 |
| OrderRow 索引 | `src/xianyu_hunter/infra/db_models.py` | 174-177 |
| TaskDepRow 模型 | `src/xianyu_hunter/infra/db_models.py` | 286-295 |
| Buyer 类 | `src/xianyu_hunter/modules/buyer.py` | 57+ |
| buyer.buy 方法 | `src/xianyu_hunter/modules/buyer.py` | 91+ |
| _task_item_set (LRU 幂等) | `src/xianyu_hunter/modules/buyer.py` | 87 |
| BuyerConfig | `src/xianyu_hunter/modules/buyer_config.py` | 11-26 |
| TakeoverTimeoutScheduler 类 | `src/xianyu_hunter/modules/takeover_timeout_scheduler.py` | 32-92 |
| _DEFAULT_SCAN_INTERVAL_MIN | `src/xianyu_hunter/modules/takeover_timeout_scheduler.py` | 29 |
