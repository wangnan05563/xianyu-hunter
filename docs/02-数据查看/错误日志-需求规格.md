...
| 错误日志 后端 API | [../../backend/xianyu_hunter/web/routes/api_error_logs.py](../../backend/xianyu_hunter/web/routes/api_error_logs.py) | 7 个端点 + 内部辅助函数 |
| 错误日志 后端 Repo | [../../backend/xianyu_hunter/infra/repo_error_logs.py](../../backend/xianyu_hunter/infra/repo_error_logs.py) | ErrorLogsMixin（9 个方法） |
| 错误捕获中间件 | [../../backend/xianyu_hunter/web/middleware/error_capture.py](../../backend/xianyu_hunter/web/middleware/error_capture.py) | 双入口 + AI 上下文构建 + 脱敏 |
| 异常处理器 | [../../backend/xianyu_hunter/web/middleware/exception_handler.py](../../backend/xianyu_hunter/web/middleware/exception_handler.py) | 调用 `capture_request_error` |
| request_id 上下文 | [../../backend/xianyu_hunter/infra/request_context.py](../../backend/xianyu_hunter/infra/request_context.py) | 生成 / 校验 / 异步安全传递 |
| DB 模型 | [../../backend/xianyu_hunter/infra/db_models.py](../../backend/xianyu_hunter/infra/db_models.py) | `ErrorLogRow` 定义（17 字段，无 updated_at） |
| 搜索服务 | [../../backend/xianyu_hunter/web/services/search_services.py](../../backend/xianyu_hunter/web/services/search_services.py) | `ErrorLogSearchService` 分页 + 慢查询埋点 |
...
1. **集成部署**：作为 `backend/xianyu_hunter/web/routes/api_error_logs.py` 路由 + `frontend/src/pages/Logs/ErrorLogs.tsx` 页面集成到现有系统，不独立部署
...
**FR-3.1** 双入口定义（`backend/xianyu_hunter/web/middleware/error_capture.py`），均写入 `error_logs` 表，统一调用 `_save_error_log` 内部函数：
...
所有接口前缀：`/api/error-logs`，路由文件：`backend/xianyu_hunter/web/routes/api_error_logs.py`，认证：复用现有 `auth.py` 中间件（**不加入白名单**）。
...
| 模块 | 文件路径 | 行号 |
|------|----------|------|
| 路由声明（router） | `backend/xianyu_hunter/web/routes/api_error_logs.py` | 32 |
| ERROR_LOG_NOT_FOUND_MSG 常量 | `backend/xianyu_hunter/web/routes/api_error_logs.py` | 35 |
| BatchActionRequest 模型 | `backend/xianyu_hunter/web/routes/api_error_logs.py` | 38-44 |
| `_parse_json_fields` 内部函数 | `backend/xianyu_hunter/web/routes/api_error_logs.py` | 47-55 |
| `GET /api/error-logs` 列表 | `backend/xianyu_hunter/web/routes/api_error_logs.py` | 58-88 |
| `GET /api/error-logs/{id}` 详情 | `backend/xianyu_hunter/web/routes/api_error_logs.py` | 91-100 |
| `POST /api/error-logs/batch` 批量 | `backend/xianyu_hunter/web/routes/api_error_logs.py` | 103-122 |
| `GET /api/error-logs/{id}/ai-context` AI 上下文 | `backend/xianyu_hunter/web/routes/api_error_logs.py` | 125-144 |
| `PATCH /api/error-logs/{id}/status` 状态 | `backend/xianyu_hunter/web/routes/api_error_logs.py` | 147-157 |
| `DELETE /api/error-logs/{id}` 删除 | `backend/xianyu_hunter/web/routes/api_error_logs.py` | 160-169 |
| `POST /api/error-logs/cleanup` 清理 | `backend/xianyu_hunter/web/routes/api_error_logs.py` | 172-179 |
| ErrorLogsMixin 类 | `backend/xianyu_hunter/infra/repo_error_logs.py` | 17 |
| `save_error_log` 方法 | `backend/xianyu_hunter/infra/repo_error_logs.py` | 20-31 |
| `list_error_logs` 方法 | `backend/xianyu_hunter/infra/repo_error_logs.py` | 33-62 |
| `get_error_log` 方法 | `backend/xianyu_hunter/infra/repo_error_logs.py` | 64-70 |
| `update_error_log_status` 方法 | `backend/xianyu_hunter/infra/repo_error_logs.py` | 72-80 |
| `delete_error_log` 方法 | `backend/xianyu_hunter/infra/repo_error_logs.py` | 82-88 |
| `batch_update_error_log_status` 方法 | `backend/xianyu_hunter/infra/repo_error_logs.py` | 90-103 |
| `batch_delete_error_logs` 方法 | `backend/xianyu_hunter/infra/repo_error_logs.py` | 105-113 |
| `count_error_logs_by_status` 方法 | `backend/xianyu_hunter/infra/repo_error_logs.py` | 115-122 |
| `cleanup_old_error_logs` 方法 | `backend/xianyu_hunter/infra/repo_error_logs.py` | 124-136 |
| `_SENSITIVE_HEADERS` 黑名单 | `backend/xianyu_hunter/web/middleware/error_capture.py` | 25 |
| `_sanitize_headers` 函数 | `backend/xianyu_hunter/web/middleware/error_capture.py` | 28-36 |
| `_collect_server_env` 函数 | `backend/xianyu_hunter/web/middleware/error_capture.py` | 39-46 |
| `_infer_possible_causes` 函数 | `backend/xianyu_hunter/web/middleware/error_capture.py` | 49-70 |
| `_build_request_context_md_lines` 函数 | `backend/xianyu_hunter/web/middleware/error_capture.py` | 73-91 |
| `_build_ai_context_json` 函数 | `backend/xianyu_hunter/web/middleware/error_capture.py` | 94-111 |
| `_build_ai_context_md` 函数 | `backend/xianyu_hunter/web/middleware/error_capture.py` | 114-149 |
| `_save_error_log` 内部函数 | `backend/xianyu_hunter/web/middleware/error_capture.py` | 152-213 |
| `capture_request_error` 入口 | `backend/xianyu_hunter/web/middleware/error_capture.py` | 216-258 |
| `capture_background_error` 入口 | `backend/xianyu_hunter/web/middleware/error_capture.py` | 261-297 |
| `generate_request_id` 函数 | `backend/xianyu_hunter/infra/request_context.py` | 31-44 |
| `get_request_id` 函数 | `backend/xianyu_hunter/infra/request_context.py` | 47-53 |
| `is_valid_request_id` 函数 | `backend/xianyu_hunter/infra/request_context.py` | 93-112 |
| ErrorLogRow 模型 | `backend/xianyu_hunter/infra/db_models.py` | 219-250 |
| ErrorLogSearchService 类 | `backend/xianyu_hunter/web/services/search_services.py` | 80+ |
