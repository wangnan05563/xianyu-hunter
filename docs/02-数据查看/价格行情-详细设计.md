...
| 模块                  | 文件路径                                                                                                |
| --------------------- | ------------------------------------------------------------------------------------------------------- |
| 品类统计 API          | `backend/xianyu_hunter/web/routes/price_dashboard.py`                                                       |
| 价格直方图 API        | `backend/xianyu_hunter/web/routes/price_histogram.py`                                                       |
| 价格趋势 API          | `backend/xianyu_hunter/web/routes/stats_price_trend.py`                                                     |
| DB 模型               | `backend/xianyu_hunter/infra/db_models.py`（ItemRow:98 / TaskRow:50 / TaskLinkRow:256）                     |
