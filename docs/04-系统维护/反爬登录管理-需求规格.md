...
| 反爬登录管理 后端 | [../../backend/xianyu_hunter/web/routes/api_anticrawl.py](../../backend/xianyu_hunter/web/routes/api_anticrawl.py) | 18 个内部辅助函数 + 13 个端点 |
...
| LoginOrchestrator | [../../backend/xianyu_hunter/modules/login_orchestrator.py](../../backend/xianyu_hunter/modules/login_orchestrator.py) | 协调器单例、SessionStatus dataclass、自愈机制 |
| CookieRotator | [../../backend/xianyu_hunter/modules/cookie_rotator.py](../../backend/xianyu_hunter/modules/cookie_rotator.py) | LAYER_DEFINITIONS、LayerState、is_m5tk_expired |
| SessionHealthChecker | [../../backend/xianyu_hunter/modules/session_health.py](../../backend/xianyu_hunter/modules/session_health.py) | HealthReport、HealthAction、WAFStatus 枚举 |
| TokenRenewer | [../../backend/xianyu_hunter/modules/token_renewer.py](../../backend/xianyu_hunter/modules/token_renewer.py) | 后台续期器实现 |
| Fingerprint | [../../backend/xianyu_hunter/modules/fingerprint.py](../../backend/xianyu_hunter/modules/fingerprint.py) | FingerprintProfile、build_stealth_script |
| FreqDisguise | [../../backend/xianyu_hunter/modules/freq_disguise.py](../../backend/xianyu_hunter/modules/freq_disguise.py) | 频率伪装 ActionType |
| CookieStore | [../../backend/xianyu_hunter/web/services/cookie_store.py](../../backend/xianyu_hunter/web/services/cookie_store.py) | JSON 持久化 + 30s TTL 缓存 |
| 浏览器导入 | [../../backend/xianyu_hunter/web/routes/browser_import.py](../../backend/xianyu_hunter/web/routes/browser_import.py) | DPAPI / AES-256-GCM / 明文解密 + 4 级降级文件复制 |
...
1. **集成部署**：作为 `backend/xianyu_hunter/web/routes/api_anticrawl.py` 路由 + `frontend/src/pages/AntiCrawl/index.tsx` 页面集成到现有系统，不独立部署
...
所有接口前缀：`/api/anticrawl`，路由文件：`backend/xianyu_hunter/web/routes/api_anticrawl.py`，认证：复用现有 `auth.py` 中间件（**不加入白名单**）。
...
| LAYER_DEFINITIONS | `backend/xianyu_hunter/modules/cookie_rotator.py` | 60-80 |
