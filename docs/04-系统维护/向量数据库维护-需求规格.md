...
| 后端路由 | [src/xianyu_hunter/web/routes/api_vector_admin.py](../../src/xianyu_hunter/web/routes/api_vector_admin.py) | 8 个端点实现 |
| VectorStore | [src/xianyu_hunter/modules/chatbot/vector_store.py](../../src/xianyu_hunter/modules/chatbot/vector_store.py) | ChromaDB 适配器、快照导出/恢复 |
| KBManager | [src/xianyu_hunter/modules/chatbot/kb_manager.py](../../src/xianyu_hunter/modules/chatbot/kb_manager.py) | 排除目录、KB 版本快照 |
| ChatbotRepository | [src/xianyu_hunter/infra/repo_chatbot.py](../../src/xianyu_hunter/infra/repo_chatbot.py) | `add_audit_log` / `list_audit_logs` |
| ChatbotAuditLogRow | [src/xianyu_hunter/infra/db_models.py](../../src/xianyu_hunter/infra/db_models.py) | 审计日志表模型 |
...
1. **集成部署**：作为 `src/xianyu_hunter/web/routes/api_vector_admin.py` 路由文件集成到现有 Web 进程，不独立部署
...
**模型类**：[`src/xianyu_hunter/infra/db_models.py`](../../src/xianyu_hunter/infra/db_models.py) `ChatbotAuditLogRow`
