...
| 后端路由聚合 | [../../src/xianyu_hunter/web/routes/api_stats.py](../../src/xianyu_hunter/web/routes/api_stats.py) | 10 个子模块 router 聚合入口 |
| 总览统计后端 | [../../src/xianyu_hunter/web/routes/stats_overview.py](../../src/xianyu_hunter/web/routes/stats_overview.py) | `/api/stats` + `/api/events/recent` |
| 今日异常后端 | [../../src/xianyu_hunter/web/routes/stats_today.py](../../src/xianyu_hunter/web/routes/stats_today.py) | `/api/stats/today` |
| 业务 KPI 后端 | [../../src/xianyu_hunter/web/routes/business_kpi.py](../../src/xianyu_hunter/web/routes/business_kpi.py) | `/api/stats/business-kpi` |
| 趋势数据后端 | [../../src/xianyu_hunter/web/routes/trend.py](../../src/xianyu_hunter/web/routes/trend.py) | `/api/stats/trend` |
| 评估漏斗后端 | [../../src/xianyu_hunter/web/routes/stats_eval_funnel.py](../../src/xianyu_hunter/web/routes/stats_eval_funnel.py) | `/api/stats/eval-funnel` |
| 价格直方图后端 | [../../src/xianyu_hunter/web/routes/price_histogram.py](../../src/xianyu_hunter/web/routes/price_histogram.py) | `/api/prices/histogram` + `/api/prices/analyze` |
| 价格趋势后端 | [../../src/xianyu_hunter/web/routes/stats_price_trend.py](../../src/xianyu_hunter/web/routes/stats_price_trend.py) | `/api/stats/price-trend` |
| SSE 事件流后端 | [../../src/xianyu_hunter/web/routes/sse_stream.py](../../src/xianyu_hunter/web/routes/sse_stream.py) | `/api/events/stream` |
...
1. **集成部署**：作为 `src/xianyu_hunter/web/routes/api_stats.py` 路由聚合 + `frontend/src/pages/Dashboard/` 页面集成到现有系统，不独立部署
...
| 后端路由聚合 | `src/xianyu_hunter/web/routes/api_stats.py` | 10 个子模块 re-export |
| 总览统计后端 | `src/xianyu_hunter/web/routes/stats_overview.py` | `_overview` / `recent_events` |
| 今日异常后端 | `src/xianyu_hunter/web/routes/stats_today.py` | `today_stats` |
| 业务 KPI 后端 | `src/xianyu_hunter/web/routes/business_kpi.py` | `business_kpi` / `_kpi_items_discovered` / `_kpi_eval_pass_rate` / `_kpi_order_success_rate` / `_kpi_notify_failure_rate` |
| 趋势数据后端 | `src/xianyu_hunter/web/routes/trend.py` | `stats_trend` / `_build_trend_series` / `_RANGE_BUCKET_COUNT` |
| 评估漏斗后端 | `src/xianyu_hunter/web/routes/stats_eval_funnel.py` | `eval_funnel` / `_stage` / `_safe_rate` |
| 价格直方图后端 | `src/xianyu_hunter/web/routes/price_histogram.py` | `prices_histogram` / `prices_analyze` / `_build_compare_means` / `_build_buckets` / `_build_auto_bins` |
| 价格趋势基线后端 | `src/xianyu_hunter/web/routes/stats_price_trend.py` | `price_trend` / `_safe_mean` / `_safe_diff` |
| SSE 事件流后端 | `src/xianyu_hunter/web/routes/sse_stream.py` | `sse_stream` / `_MAX_SSE_CONNECTIONS` / `_sse_connection_count` |
