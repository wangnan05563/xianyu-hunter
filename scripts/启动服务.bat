...
REM [3/4] Start Web server (Ĭ�ϵ�����ģʽ������� + �������� + �����ɼ�ͬ����)
REM �� xianyu web ����Ĭ������ --with-scheduler��������ʽ����
REM ���贿 Web ģʽ���������������������: -m xianyu_hunter web --no-with-scheduler
...
echo.
echo To stop: double-click scripts\ֹͣ����.bat
echo.
